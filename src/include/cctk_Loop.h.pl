...
for $dim (1,2,3,4) {
    ...
    push @lines, map {expand $_} (
        ...
        (rpt (bsnl '      cctk_loop_max(cctki2_cctkGH->cctk_tile_min[[I]], cctki2_blo[[I]]),')),
        (bsnl '    };'),
        (bsnl '    const int cctki2_imax[] = {'),
        (rpt (bsnl '      cctk_loop_min(cctki2_cctkGH->cctk_tile_max[[I]], cctki2_cctkGH->cctk_lsh[[I]] - cctki2_bhi[[I]]),')),
        (bsnl '    };'),
        ...
        (rpt (bsnl '          cctk_loop_max(cctki2_cctkGH->cctk_tile_min[[I]], (int)(cctki2_[C]dir<0 ? 0 : cctki2_[C]dir==0 ? cctki2_blo[[I]] : cctki2_lsh[[I]] - cctki2_bhi[[I]])),')),
        (bsnl '        };'),
        (bsnl '        const int cctki2_bmax[] = {'),
        (rpt (bsnl '          cctk_loop_min(cctki2_cctkGH->cctk_tile_max[[I]], (int)(cctki2_[C]dir<0 ? cctki2_blo[[I]] : cctki2_[C]dir==0 ? cctki2_lsh[[I]] - cctki2_bhi[[I]] : cctki2_lsh[[I]])),')),
        (bsnl '        };'),
        ...
        (bsnl '                     '.(crpt '[C]').','),
        (rpt (bsnl '                     cctki3_cctkGH->cctk_tile_min[[I]],')),
        (rpt (bsnl '                     cctki3_cctkGH->cctk_tile_max[[I]],')),
        ...
        (bsnl '    GetBoundarySizesAndTypes(cctki3_cctkGH,'),
        (bsnl '                             [2*DIM],'),
        (bsnl '                             cctki3_bndsize,'),
        ...
        (bsnl '   & && !$omp private(name/**/0_dummy_imin, name/**/0_dummy_imax)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]_NORMAL(name,'),
        (bsnl '                          '.(crpt '[C]').','),
        (bsnl '                          '.(crpt 'n[C]').','),
        ...
        (bsnl '  private('.(crpt 'name/**/0_[C]dir').')'),
        (bsnl '  & && !$omp private('.(crpt 'name/**/0_[C]min').')'),
        (bsnl '  & && !$omp private('.(crpt 'name/**/0_[C]max').')'),
        (bsnl '  & && !$omp private('.(crpt 'name/**/0_[C]ash').')'),
        (bsnl '  & && !$omp private(name/**/0_istr)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STR_NORMAL(name,'),
        (bsnl '                             '.(crpt '[C]').','),
        (bsnl '                             '.(crpt 'n[C]').','),
        ...
        (bsnl '   & && !$omp private(name/**/1_dummy_imin, name/**/1_dummy_imax)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM](name,'),
        (bsnl '                   '.(crpt '[C]').','),
        (bsnl '                   '.(crpt 'cctki0_[C]min').','),
        ...
        (bsnl '   CCTK_LOOP[DIM]STR_NORMAL_OMP_PRIVATE(name)'),
        (bsnl '   & && !$omp private('.(crpt 'name/**/1_n[C]').')'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STR(name,'),
        (bsnl '                      '.(crpt '[C]').','),
        ...
        (bsnl '   & && !$omp private(name/**/2_dummy_imin, name/**/2_dummy_imax)'),
        (nl ''),
        ...
        (bsnl '                 '.(crpt '[C]').','),
        (rpt (bsnl '                 max(cctk_tile_min([I+1])+1, (cctki2_[C]blo)+1),')),
        (rpt (bsnl '                 min(cctk_tile_max([I+1]), cctk_lsh([I+1])-(cctki2_[C]bhi)),')),
        ...
        (bsnl '   && integer :: '.(crpt 'name/**/2_[C]dir')),
        ...
        (bsnl '   & && !$omp private(name/**/2_blo, name/**/2_bhi)'),
        (bsnl '   & && !$omp private(name/**/2_bboxlo, name/**/2_bboxhi)'),
        (bsnl '   & && !$omp private(name/**/2_istr)'),
        (bsnl '   & && !$omp private('.(crpt 'name/**/2_[C]dir').')'),
        (bsnl '   & && !$omp private(name/**/2_any_bbox)'),
        ...
        (bsnl '                                 '.(crpt 'max(cctk_tile_min([I+1])+1, name/**/2_bmin([I+1]))').', '),
        (bsnl '                                 '.(crpt 'min(cctk_tile_max([I+1]), name/**/2_bmax([I+1]))').', '),
        (bsnl '                                 '.(crpt 'cctk_ash([I+1])').','),
        ...
        (bsnl '   & && !$omp private(name/**/3_dummy_imin, name/**/3_dummy_imax)'),
        (nl ''),
        ...
        (bsnl '   & && !$omp private(name/**/3_bndsize)'),
        (bsnl '   & && !$omp private(name/**/3_is_ghostbnd)'),
        (bsnl '   & && !$omp private(name/**/3_is_symbnd)'),
        (bsnl '   & && !$omp private(name/**/3_is_physbnd)'),
        (bsnl '   & && !$omp private(name/**/3_ierr)'),
        (nl ''),
