...
# Each macro exists in three versions, a regular one, a strided one
# (STR), and a strided one with offset (STROFF). The strided macros
# are intended for vectorised code, and the stride should be the
# vector size. The offset can be used to indicate a non-trivial
# alignment of the array origin, if e.g. the first interior grid point
# is aligned instead of the first array element.
...
push @lines, (
    ...
    (nl '#    define CCTK_PRAGMA_OMP_FOR_COLLAPSE_1 CCTK_PRAGMA_OMP("omp for collapse(1)")'),
    (nl '#    define CCTK_PRAGMA_OMP_FOR_COLLAPSE_2 CCTK_PRAGMA_OMP("omp for collapse(2)")'),
    (nl '#    define CCTK_PRAGMA_OMP_FOR_COLLAPSE_3 CCTK_PRAGMA_OMP("omp for collapse(3)")'),
    (nl '#    define CCTK_PRAGMA_OMP_FOR_COLLAPSE_4 CCTK_PRAGMA_OMP("omp for collapse(4)")'),
    (nl '#  else'),
    (nl '#    define CCTK_PRAGMA_OMP_FOR_COLLAPSE_1 CCTK_PRAGMA_OMP("omp for")'),
    (nl '#    define CCTK_PRAGMA_OMP_FOR_COLLAPSE_2 CCTK_PRAGMA_OMP("omp for")'),
    (nl '#    define CCTK_PRAGMA_OMP_FOR_COLLAPSE_3 CCTK_PRAGMA_OMP("omp for")'),
    (nl '#    define CCTK_PRAGMA_OMP_FOR_COLLAPSE_4 CCTK_PRAGMA_OMP("omp for")'),
    (nl '#  endif'),
    (nl ''),
    (nl '#  ifdef CCTK_HAVE_CGH_TILE'),
    (nl '#    define CCTK_LOOP_TILE_MIN(cctkGH, d) (cctkGH)->cctk_tile_min[d]'),
    (nl '#    define CCTK_LOOP_TILE_MAX(cctkGH, d) (cctkGH)->cctk_tile_max[d]'),
    (nl '#  else'),
    (nl '#    define CCTK_LOOP_TILE_MIN(cctkGH, d) 0'),
    (nl '#    define CCTK_LOOP_TILE_MAX(cctkGH, d) (cctkGH)->cctk_lsh[d]'),
    (nl '#  endif'),
    (nl ''),
    (nl '#ifdef __cplusplus'),
    (nl 'extern "C" {'),
    (nl '#endif'),
    (nl 'CCTK_INT GetBoundarySizesAndTypes(const void* cctkGH,'),
    (nl '                                  CCTK_INT size,'),
    (nl '                                  CCTK_INT* bndsize,'),
    (nl '                                  CCTK_INT* is_ghostbnd,'),
    (nl '                                  CCTK_INT* is_symbnd,'),
    (nl '                                  CCTK_INT* is_physbnd);'),
    (nl '#ifdef __cplusplus'),
    (nl '}'),
    (nl '#endif'),
    (nl ''),
    (nl 'CCTK_ATTRIBUTE_UNUSED static int cctk_loop_min(int i, int j) {'),
    (nl '  return i <= j ? i : j;'),
    (nl '}'),
    (nl 'CCTK_ATTRIBUTE_UNUSED static int cctk_loop_max(int i, int j) {'),
    (nl '  return i > j ? i : j;'),
    (nl '}'),
    (nl ''),
...
for $dim (1,2,3,4) {
    ...
    push @lines, map {expand $_} (
        ...
        (nl '#ifdef CCODE'),
        (nl ''),
        (nl 'CCTK_ATTRIBUTE_UNUSED static void'),
        (nl 'cctk_loop_get_bndsize[DIM](const cGH* cctkGH,'),
        (nl '                       const CCTK_INT* restrict* bndsizep,'),
        (nl '                       const CCTK_INT* restrict* is_ghostbndp,'),
        (nl '                       const CCTK_INT* restrict* is_symbndp,'),
        (nl '                       const CCTK_INT* restrict* is_physbndp) {'),
        (nl '  static int atomic_have_bndsize = 0;'),
        (nl '  static CCTK_INT bndsize    [[2*DIM]];'),
        (nl '  static CCTK_INT is_ghostbnd[[2*DIM]];'),
        (nl '  static CCTK_INT is_symbnd  [[2*DIM]];'),
        (nl '  static CCTK_INT is_physbnd [[2*DIM]];'),
        (nl '  int have_bndsize;'),
        (nl '  _Pragma("omp atomic read")'),
        (nl '  have_bndsize = atomic_have_bndsize;'),
        (nl '  if (!have_bndsize) {'),
        (nl '    CCTK_PRAGMA_OMP("omp single")'),
        (nl '    {'),
        (nl '      GetBoundarySizesAndTypes'),
        (nl '        (cctkGH, [2*DIM], bndsize, is_ghostbnd, is_symbnd, is_physbnd);'),
        (nl '    }'),
        (nl '    _Pragma("omp atomic write")'),
        (nl '    atomic_have_bndsize = 1;'),
        (nl '  }'),
        (nl '  *bndsizep     = bndsize;'),
        (nl '  *is_ghostbndp = is_ghostbnd;'),
        (nl '  *is_symbndp   = is_symbnd;'),
        (nl '  *is_physbndp  = is_physbnd;'),
        (nl '}'),
        (nl ''),
        (nl ''),
        (nl ''),
        ...
        (bsnl '  CCTK_LOOP[DIM]STROFF_NORMAL(name,'),
        (bsnl '                          '.(crpt '[C]').','),
        (bsnl '                          '.(crpt 'n[C]').','),
        (bsnl '                          '.(crpt '(cctki0_[C]dir_)').','),
        (bsnl '                          '.(crpt '(cctki0_[C]min_)').','),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_NORMAL(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF_NORMAL(name,'),
        (bsnl '                                '.(crpt '[C]').','),
        (bsnl '                                '.(crpt 'n[C]').','),
        (bsnl '                                '.(crpt 'cctki0_[C]dir_').','),
        (bsnl '                                '.(crpt 'cctki0_[C]min_').','),
        (bsnl '                                '.(crpt 'cctki0_[C]max_').','),
        (bsnl '                                '.(crpt 'cctki0_[C]ash_').','),
        (bsnl '                                cctki0_ialn_,cctki0_ioff_,'),
        (bsnl '                                imin,imax, cctki0_istr_)'),
        (bsnl '  do {'),
        ...
        # Ensure alignment modulus is compatible with stride
        (bsnl '    assert(cctki0_ioff>=0 && cctki0_ioff<cctki0_ialn);'),
        # Ensure stride is positive
        (bsnl '    assert(cctki0_istr>0);'),
        ...
        (bsnl ('    const int cctki0_ioff1 = ' . (sep '', rpt '[I==1?(cctki0_imin:+cctki0_[C-1]ash*([C]]') . (sep '', rpt ')') . ' + cctki0_ioff;')),
        # TODO: Omit this when grid arrays are aligned
        (bsnl '    const int cctki0_ioff2 = cctki0_ioff1 % cctki0_istr;'),
        (bsnl '    [DIM==1?CCTK_PRAGMA_OMP("omp for"):]'),
        (bsnl '    for (int i=cctki0_imin-cctki0_ioff2; i<cctki0_imax; i+=cctki0_istr) {'),
        (rpt (bsnl '      const int n[C] CCTK_ATTRIBUTE_UNUSED = cctki0_[C]dir<0 ? [C]+1 : cctki0_[C]dir==0 ? 0 : cctki0_[C]max-[C];')),
        (bsnl '      {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF_NORMAL(name)'),
        (bsnl '      }'),
        (rpt (bsnl '    }')),
        ...
        (bsnl '  CCTK_LOOP[DIM]STROFF(name,'),
        (bsnl '                   '.(crpt '[C]').','),
        (bsnl '                   '.(crpt '(cctki1_[C]min_)').','),
        (bsnl '                   '.(crpt '(cctki1_[C]max_)').','),
        (bsnl '                   '.(crpt '(cctki1_[C]ash_)').','),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF(name,'),
        (bsnl '                         '.(crpt '[C]').','),
        (bsnl '                         '.(crpt 'cctki1_[C]min_').','),
        (bsnl '                         '.(crpt 'cctki1_[C]max_').','),
        (bsnl '                         '.(crpt 'cctki1_[C]ash_').','),
        (bsnl '                         cctki1_ialn_,cctki1_ioff_,'),
        (bsnl '                         imin,imax, cctki1_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STROFF_NORMAL(name,'),
        (bsnl '                          '.(crpt '[C]').','),
        ...
        (bsnl '                          imin,imax, (cctki1_istr_))'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_NORMAL(name)'),
        (nl ''),
        (nl ''),
        (nl ''),
        ...
        (bsnl '  CCTK_LOOP[DIM]STROFF_INTERIOR(name, (cctki2_cctkGH_),'),
        (bsnl '                            '.(crpt '[C]').','),
        (bsnl '                            '.(crpt '(cctki2_[C]blo_)').','),
        (bsnl '                            '.(crpt '(cctki2_[C]bhi_)').','),
        (bsnl '                            (cctki2_istr_), 0,'),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_INTERIOR(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF_INTERIOR(name, cctki2_cctkGH_,'),
        (bsnl '                                  '.(crpt '[C]').','),
        (bsnl '                                  '.(crpt 'cctki2_[C]blo_').','),
        (bsnl '                                  '.(crpt 'cctki2_[C]bhi_').','),
        (bsnl '                                  cctki2_ialn_,cctki2_ioff_,'),
        (bsnl '                                  imin,imax, cctki2_istr_)'),
        (bsnl '  do {'),
        ...
        (bsnl '      CCTK_ERROR("The macro CCTK_LOOP[DIM]_INTERIOR can only be used in [DIM] dimensions");'),
        (bsnl '    }'),
        (bsnl '    const int cctki2_blo[] = {'.(crpt ' (int)(cctki2_[C]blo_)').' };'),
        (bsnl '    const int cctki2_bhi[] = {'.(crpt ' (int)(cctki2_[C]bhi_)').' };'),
        (bsnl '    const int cctki2_imin[] = {'),
        (rpt (bsnl '      cctk_loop_max(CCTK_LOOP_TILE_MIN(cctki2_cctkGH, [I]), cctki2_blo[[I]]),')),
        (bsnl '    };'),
        (bsnl '    const int cctki2_imax[] = {'),
        (rpt (bsnl '      cctk_loop_min(CCTK_LOOP_TILE_MAX(cctki2_cctkGH, [I]), cctki2_cctkGH->cctk_lsh[[I]] - cctki2_bhi[[I]]),')),
        (bsnl '    };'),
        (bsnl '    CCTK_LOOP[DIM]STROFF(name##_interior,'),
        (bsnl '                     '.(crpt '[C]').','),
        (bsnl '                     '.(crpt 'cctki2_imin[[I]]').','),
        (bsnl '                     '.(crpt 'cctki2_imax[[I]]').','),
        (rpt (bsnl '                     cctki2_cctkGH->cctk_ash[[I]],')),
        (bsnl '                     (cctki2_ialn_),(cctki2_ioff_),'),
        (bsnl '                     imin,imax, (cctki2_istr_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF_INTERIOR(name)'),
        (bsnl '    } CCTK_ENDLOOP[DIM]STROFF(name##_interior);'),
        ...
        (bsnl '                                 '.(crpt 'cctki2_[C]bboxhi_').','),
        (bsnl '                                 imin,imax, cctki2_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STROFF_BOUNDARIES(name, (cctki2_cctkGH_),'),
        (bsnl '                              '.(crpt '[C]').','),
        (bsnl '                              '.(crpt 'n[C]').','),
        (bsnl '                              '.(crpt '(cctki2_[C]blo_)').','),
        (bsnl '                              '.(crpt '(cctki2_[C]bhi_)').','),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_BOUNDARIES(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF_BOUNDARIES(name, cctki2_cctkGH_,'),
        (bsnl '                                    '.(crpt '[C]').','),
        (bsnl '                                    '.(crpt 'n[C]').','),
        (bsnl '                                    '.(crpt 'cctki2_[C]blo_').','),
        (bsnl '                                    '.(crpt 'cctki2_[C]bhi_').','),
        ...
        (bsnl '    if (cctki2_cctkGH->cctk_dim != [DIM]) {'),
        (bsnl '      _Pragma("omp critical")'),
        (bsnl '      CCTK_ERROR("The macro CCTK_LOOP[DIM]_BOUNDARIES can only be used in [DIM] dimensions");'),
        (bsnl '    }'),
        (bsnl '    const int cctki2_blo[] = {'.(crpt ' (int)(cctki2_[C]blo_)').' };'),
        (bsnl '    const int cctki2_bhi[] = {'.(crpt ' (int)(cctki2_[C]bhi_)').' };'),
        (bsnl '    const int cctki2_bbox[] = {'.(crpt ' (int)(cctki2_[C]bboxlo_), (int)(cctki2_[C]bboxhi_)').' };'),
        (bsnl '    const int cctki2_lsh[] = {'.(crpt ' (int)cctki2_cctkGH->cctk_lsh[[I]]').' };'),
        (bsnl '    const int cctki2_ialn CCTK_ATTRIBUTE_UNUSED = (cctki2_ialn_);'),
        (bsnl '    const int cctki2_ioff CCTK_ATTRIBUTE_UNUSED = (cctki2_ioff_);'),
        ...
        (rpt (bsnl '          cctk_loop_max(CCTK_LOOP_TILE_MIN(cctki2_cctkGH, [I]), (int)(cctki2_[C]dir<0 ? 0 : cctki2_[C]dir==0 ? cctki2_blo[[I]] : cctki2_lsh[[I]] - cctki2_bhi[[I]])),')),
        (bsnl '        };'),
        (bsnl '        const int cctki2_bmax[] = {'),
        (rpt (bsnl '          cctk_loop_min(CCTK_LOOP_TILE_MAX(cctki2_cctkGH, [I]), (int)(cctki2_[C]dir<0 ? cctki2_blo[[I]] : cctki2_[C]dir==0 ? cctki2_lsh[[I]] - cctki2_bhi[[I]] : cctki2_lsh[[I]])),')),
        (bsnl '        };'),
        (bsnl '        CCTK_LOOP[DIM]STROFF_NORMAL(name##_boundaries,'),
        (bsnl '                                '.(crpt '[C]').','),
        (bsnl '                                '.(crpt 'n[C]').','),
        ...
        (rpt (bsnl '                                cctki2_cctkGH->cctk_ash[[I]],')),
        (bsnl '                                cctki2_ialn,cctki2_ioff,'),
        (bsnl '                                imin,imax, cctki2_istr) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF_BOUNDARIES(name)'),
        (bsnl '        } CCTK_ENDLOOP[DIM]STROFF_NORMAL(name##_boundaries);'),
        (bsnl '      } /* if bbox */'),
        ...
        (bsnl '                                    '.(crpt 'cctki2_[C]bboxhi_').','),
        (bsnl '                                    imin,imax, cctki2_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STROFF_INTBOUNDARIES(name, (cctki2_cctkGH_),'),
        (bsnl '                                 '.(crpt '[C]').','),
        (bsnl '                                 '.(crpt 'n[C]').','),
        (bsnl '                                 '.(crpt '(cctki2_[C]blo_)').','),
        (bsnl '                                 '.(crpt '(cctki2_[C]bhi_)').','),
        ...
        (bsnl '                                 '.(crpt '(cctki2_[C]bboxhi_)').','),
        (bsnl '                                 (cctki2_str_),0,'),
        (bsnl '                                 imin,imax, (cctki2_str_))'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_INTBOUNDARIES(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_INTBOUNDARIES(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF_INTBOUNDARIES(name, cctki2_cctkGH_,'),
        (bsnl '                                       '.(crpt '[C]').','),
        (bsnl '                                       '.(crpt 'n[C]').','),
        (bsnl '                                       '.(crpt 'cctki2_[C]blo_').','),
        (bsnl '                                       '.(crpt 'cctki2_[C]bhi_').','),
        ...
        (bsnl '    if (cctki2_cctkGH->cctk_dim != [DIM]) {'),
        (bsnl '      _Pragma("omp critical")'),
        (bsnl '      CCTK_ERROR("The macro CCTK_LOOP[DIM]_INTBOUNDARIES can only be used in [DIM] dimensions");'),
        (bsnl '    }'),
        (bsnl '    const int cctki2_blo[] = {'.(crpt ' (int)(cctki2_[C]blo_)').' };'),
        (bsnl '    const int cctki2_bhi[] = {'.(crpt ' (int)(cctki2_[C]bhi_)').' };'),
        (bsnl '    const int cctki2_bbox[] = {'.(crpt ' (int)(cctki2_[C]bboxlo_), (int)(cctki2_[C]bboxhi_)').' };'),
        ...
        (rpt (bsnl '          cctk_loop_min(CCTK_LOOP_TILE_MAX(cctki2_cctkGH, [I]), (int)(cctki2_[C]dir<0 ? cctki2_blo[[I]] : cctki2_[C]dir==0 ? cctki2_lsh[[I]] - cctki2_bhi[[I]] : cctki2_lsh[[I]])),')),
        (bsnl '        };'),
        (bsnl '        CCTK_LOOP[DIM]STROFF_NORMAL(name##_intboundaries,'),
        (bsnl '                                '.(crpt '[C]').','),
        (bsnl '                                '.(crpt 'n[C]').','),
        (bsnl '                                '.(crpt 'cctki2_[C]dir').','),
        (bsnl '                                '.(crpt 'cctki2_bmin[[I]]').','),
        ...
        (bsnl '                                imin,imax, cctki2_istr) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF_INTBOUNDARIES(name)'),
        (bsnl '        } CCTK_ENDLOOP[DIM]STROFF_NORMAL(name##_intboundaries);'),
        (bsnl '      } /* if bbox */'),
        (reverse (rpt (bsnl '    } /* for dir */'))),
        ...
        (bsnl '      _Pragma("omp critical")'),
        (bsnl '      CCTK_ERROR("The macro CCTK_LOOP[DIM]_ALL can only be used in [DIM] dimensions");'),
        (bsnl '    }'),
        (bsnl '    CCTK_LOOP[DIM]STROFF(name##_all,'),
        (bsnl '                     '.(crpt '[C]').','),
        (rpt (bsnl '                     CCTK_LOOP_TILE_MIN(cctki3_cctkGH, [I]),')),
        (rpt (bsnl '                     CCTK_LOOP_TILE_MAX(cctki3_cctkGH, [I]),')),
        (rpt (bsnl '                     cctki3_cctkGH->cctk_ash[[I]],')),
        (bsnl '                     cctki3_cctkGH->cctk_alignment,cctki3_cctkGH->cctk_alignment_offset,'),
        (bsnl '                     imin,imax, (cctki3_istr_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_ALL(name)'),
        (bsnl '    } CCTK_ENDLOOP[DIM]STROFF(name##_all);'),
        ...
        (bsnl '    if (cctki3_cctkGH->cctk_dim != [DIM]) {'),
        (bsnl '      _Pragma("omp critical")'),
        (bsnl '      CCTK_ERROR("The macro CCTK_LOOP[DIM]_INT can only be used in [DIM] dimensions");'),
        (bsnl '    }'),
        (bsnl '    const CCTK_INT* restrict cctki3_bndsize;'),
        (bsnl '    const CCTK_INT* restrict cctki3_is_ghostbnd;'),
        (bsnl '    const CCTK_INT* restrict cctki3_is_symbnd;'),
        (bsnl '    const CCTK_INT* restrict cctki3_is_physbnd;'),
        (bsnl '    cctk_loop_get_bndsize[DIM](cctki3_cctkGH,'),
        (bsnl '                           &cctki3_bndsize,'),
        (bsnl '                           &cctki3_is_ghostbnd,'),
        (bsnl '                           &cctki3_is_symbnd,'),
        (bsnl '                           &cctki3_is_physbnd);'),
        (bsnl '    CCTK_LOOP[DIM]STROFF_INTERIOR(name##_int,'),
        (bsnl '                              cctki3_cctkGH,'),
        (bsnl '                              '.(crpt '[C]').','),
        ...
        (bsnl '    } CCTK_ENDLOOP[DIM]STROFF_INTERIOR(name##_int);'),
        ...
        (bsnl '    if (cctki3_cctkGH->cctk_dim != [DIM]) {'),
        (bsnl '      _Pragma("omp critical")'),
        (bsnl '      CCTK_ERROR("The macro CCTK_LOOP[DIM]_BND can only be used in [DIM] dimensions");'),
        (bsnl '    }'),
        (bsnl '    const CCTK_INT* restrict cctki3_bndsize;'),
        (bsnl '    const CCTK_INT* restrict cctki3_is_ghostbnd;'),
        (bsnl '    const CCTK_INT* restrict cctki3_is_symbnd;'),
        ...
        (bsnl '                           &cctki3_is_symbnd,'),
        (bsnl '                           &cctki3_is_physbnd);'),
        (bsnl '    CCTK_LOOP[DIM]STROFF_BOUNDARIES(name##_bnd,'),
        (bsnl '                                cctki3_cctkGH,'),
        (bsnl '                                '.(crpt '[C]').','),
        (bsnl '                                '.(crpt 'n[C]').','),
        (bsnl '                                '.(crpt 'cctki3_bndsize[[2*I]]').','),
        ...
        (bsnl '    } CCTK_ENDLOOP[DIM]STROFF_BOUNDARIES(name##_bnd);'),
        ...
        (bsnl '    if (cctki3_cctkGH->cctk_dim != [DIM]) {'),
        (bsnl '      _Pragma("omp critical")'),
        (bsnl '      CCTK_ERROR("The macro CCTK_LOOP[DIM]_INTBND can only be used in [DIM] dimensions");'),
        (bsnl '    }'),
        (bsnl '    const CCTK_INT* restrict cctki3_bndsize;'),
        (bsnl '    const CCTK_INT* restrict cctki3_is_ghostbnd;'),
        (bsnl '    const CCTK_INT* restrict cctki3_is_symbnd;'),
        ...
        (bsnl '                           &cctki3_is_symbnd,'),
        (bsnl '                           &cctki3_is_physbnd);'),
        (bsnl '    CCTK_LOOP[DIM]STROFF_INTBOUNDARIES(name##_intbnd,'),
        (bsnl '                                   cctki3_cctkGH,'),
        (bsnl '                                   '.(crpt '[C]').','),
        (bsnl '                                   '.(crpt 'n[C]').','),
        (bsnl '                                   '.(crpt 'cctki3_bndsize[[2*I]]').','),
        ...
        (bsnl '    } CCTK_ENDLOOP[DIM]STROFF_INTBOUNDARIES(name##_intbnd);'),
        ...
        (rpt (bsnl '   &&       if (name/**/2_[C]dir>0) name/**/2_bmin([I+1]) = cctk_lsh([I+1]) - name/**/2_bhi([I+1]) + 1')),
        ...
        (bsnl '                               '.(crpt '[C]').','),
        (bsnl '                               '.(crpt 'n[C]').','),
        (bsnl '                               '.(crpt 'int(name/**/3_bndsize([2*I+1]))').','),
        (bsnl '                               '.(crpt 'int(name/**/3_bndsize([2*I+2]))').','),
