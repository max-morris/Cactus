...
# (STR), and a strided one with module (STRMOD). The strided macros
# are intended for vectorised code, and the stride should be the
# vector size. The modulo offset can be used to indicate a non-trivial
...
for $dim (1,2,3,4) {
    ...
    push @lines, map {expand $_} (
        ...
        (bsnl '  CCTK_LOOP[DIM]STRMOD_NORMAL(name,'),
        (bsnl '                          '.(crpt '[C]').','),
        (bsnl '                          '.(crpt 'n[C]').','),
        (bsnl '                          '.(crpt '(cctki0_[C]dir_)').','),
        (bsnl '                          '.(crpt '(cctki0_[C]min_)').','),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_NORMAL(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD_NORMAL(name,'),
        (bsnl '                                '.(crpt '[C]').','),
        (bsnl '                                '.(crpt 'n[C]').','),
        (bsnl '                                '.(crpt 'cctki0_[C]dir_').','),
        (bsnl '                                '.(crpt 'cctki0_[C]min_').','),
        (bsnl '                                '.(crpt 'cctki0_[C]max_').','),
        (bsnl '                                '.(crpt 'cctki0_[C]ash_').','),
        (bsnl '                                imin,imax, cctki0_istr_,cctki0_imod_)'),
        (bsnl '  do {'),
        ...
        (bsnl ('    const int cctki0_ioff = (' . (sep '', rpt '[I==1?(cctki0_imin:+cctki0_[C-1]ash*([C]]') . (sep '', rpt ')') . ' - cctki0_imod) / cctki0_istr * cctki0_istr + cctki0_imod;')),
        ...
        (bsnl '      {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD_NORMAL(name)'),
        (bsnl '      }'),
        (rpt (bsnl '    }')),
        ...
        (bsnl '  CCTK_LOOP[DIM]STRMOD(name,'),
        (bsnl '                   '.(crpt '[C]').','),
        (bsnl '                   '.(crpt '(cctki1_[C]min_)').','),
        (bsnl '                   '.(crpt '(cctki1_[C]max_)').','),
        (bsnl '                   '.(crpt '(cctki1_[C]ash_)').','),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD(name,'),
        (bsnl '                         '.(crpt '[C]').','),
        (bsnl '                         '.(crpt 'cctki1_[C]min_').','),
        (bsnl '                         '.(crpt 'cctki1_[C]max_').','),
        (bsnl '                         '.(crpt 'cctki1_[C]ash_').','),
        (bsnl '                         imin,imax, cctki1_istr_,cctki1_imod_)'),
        (bsnl '  CCTK_LOOP[DIM]STRMOD_NORMAL(name,'),
        (bsnl '                          '.(crpt '[C]').','),
        ...
        (bsnl '                          imin,imax, (cctki1_istr_),(cctki1_imod_))'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_NORMAL(name)'),
        (nl ''),
        (nl ''),
        (nl ''),
        ...
        (bsnl '  CCTK_LOOP[DIM]STRMOD_INTERIOR(name, (cctki2_cctkGH_),'),
        (bsnl '                            '.(crpt '[C]').','),
        (bsnl '                            '.(crpt '(cctki2_[C]blo_)').','),
        (bsnl '                            '.(crpt '(cctki2_[C]bhi_)').','),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_INTERIOR(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD_INTERIOR(name, cctki2_cctkGH_,'),
        (bsnl '                                  '.(crpt '[C]').','),
        (bsnl '                                  '.(crpt 'cctki2_[C]blo_').','),
        (bsnl '                                  '.(crpt 'cctki2_[C]bhi_').','),
        (bsnl '                                  imin,imax, cctki2_istr_,cctki2_imod_)'),
        (bsnl '  do {'),
        ...
        (bsnl '    }'),
        (bsnl '    CCTK_LOOP[DIM]STRMOD(name##_interior,'),
        (bsnl '                     '.(crpt '[C]').','),
        (bsnl '                     '.(crpt '(cctki2_[C]blo_)').','),
        ...
        (bsnl '                     imin,imax, (cctki2_istr_),(cctki2_imod_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD_INTERIOR(name)'),
        (bsnl '    } CCTK_ENDLOOP[DIM]STRMOD(name##_interior);'),
        ...
        (bsnl '                                 '.(crpt 'cctki2_[C]bboxhi_').','),
        (bsnl '                                 imin,imax, cctki2_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STRMOD_BOUNDARIES(name, (cctki2_cctkGH_),'),
        (bsnl '                              '.(crpt '[C]').','),
        (bsnl '                              '.(crpt 'n[C]').','),
        (bsnl '                              '.(crpt '(cctki2_[C]blo_)').','),
        (bsnl '                              '.(crpt '(cctki2_[C]bhi_)').','),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_BOUNDARIES(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD_BOUNDARIES(name, cctki2_cctkGH_,'),
        (bsnl '                                    '.(crpt '[C]').','),
        (bsnl '                                    '.(crpt 'n[C]').','),
        (bsnl '                                    '.(crpt 'cctki2_[C]blo_').','),
        (bsnl '                                    '.(crpt 'cctki2_[C]bhi_').','),
        ...
        (bsnl '    const int cctki2_imod CCTK_ATTRIBUTE_UNUSED = (cctki2_imod_);'),
        ...
        (bsnl '        };'),
        (bsnl '        CCTK_LOOP[DIM]STRMOD_NORMAL(name##_boundaries,'),
        (bsnl '                                '.(crpt '[C]').','),
        (bsnl '                                '.(crpt 'n[C]').','),
        ...
        (rpt (bsnl '                                cctki2_cctkGH->cctk_ash[[I]],')),
        (bsnl '                                imin,imax, cctki2_istr,cctki2_imod) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD_BOUNDARIES(name)'),
        (bsnl '        } CCTK_ENDLOOP[DIM]STRMOD_NORMAL(name##_boundaries);'),
        (bsnl '      } /* if bbox */'),
        ...
        (bsnl '                                    '.(crpt 'cctki2_[C]bboxhi_').','),
        (bsnl '                                    imin,imax, cctki2_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STRMOD_INTBOUNDARIES(name, (cctki2_cctkGH_),'),
        (bsnl '                                 '.(crpt '[C]').','),
        (bsnl '                                 '.(crpt 'n[C]').','),
        (bsnl '                                 '.(crpt '(cctki2_[C]blo_)').','),
        (bsnl '                                 '.(crpt '(cctki2_[C]bhi_)').','),
        ...
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_INTBOUNDARIES(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD_INTBOUNDARIES(name, cctki2_cctkGH_,'),
        (bsnl '                                       '.(crpt '[C]').','),
        (bsnl '                                       '.(crpt 'n[C]').','),
        (bsnl '                                       '.(crpt 'cctki2_[C]blo_').','),
        (bsnl '                                       '.(crpt 'cctki2_[C]bhi_').','),
        ...
        (rpt (bsnl '          (int)(cctki2_[C]dir<0 ? cctki2_blo[[I]] : cctki2_[C]dir==0 ? cctki2_lsh[[I]] - cctki2_bhi[[I]] : cctki2_lsh[[I]]),')),
        (bsnl '        };'),
        (bsnl '        CCTK_LOOP[DIM]STRMOD_NORMAL(name##_intboundaries,'),
        (bsnl '                                '.(crpt '[C]').','),
        (bsnl '                                '.(crpt 'n[C]').','),
        (bsnl '                                '.(crpt 'cctki2_[C]dir').','),
        (bsnl '                                '.(crpt 'cctki2_bmin[[I]]').','),
        ...
        (bsnl '                                imin,imax, cctki2_istr,cctki2_imod) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD_INTBOUNDARIES(name)'),
        (bsnl '        } CCTK_ENDLOOP[DIM]STRMOD_NORMAL(name##_intboundaries);'),
        (bsnl '      } /* if bbox */'),
        (reverse (rpt (bsnl '    } /* for dir */'))),
        ...
        (bsnl '  CCTK_LOOP[DIM]STRMOD_ALL(name, (cctki3_cctkGH_),'),
        (bsnl '                       '.(crpt '[C]').','),
        (bsnl '                       imin,imax, (cctki3_istr_), 0)'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_ALL(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_ALL(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD_ALL(name, cctki3_cctkGH_,'),
        (bsnl '                             '.(crpt '[C]').','),
        (bsnl '                             imin,imax, cctki3_istr_,cctki3_imod_)'),
        (bsnl '  do {'),
        ...
        (bsnl '    }'),
        (bsnl '    CCTK_LOOP[DIM]STRMOD(name##_all,'),
        (bsnl '                     '.(crpt '[C]').','),
        (bsnl '                     '.(crpt '0').','),
        ...
        (bsnl '                     imin,imax, (cctki3_istr_),(cctki3_imod_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD_ALL(name)'),
        (bsnl '    } CCTK_ENDLOOP[DIM]STRMOD(name##_all);'),
        ...
        (bsnl '                          '.(crpt '[C]').','),
        (bsnl '                          imin,imax, cctki3_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STRMOD_INT(name, (cctki3_cctkGH_),'),
        (bsnl '                       '.(crpt '[C]').','),
        (bsnl '                       imin,imax, (cctki3_istr_), 0)'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_INT(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_INT(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD_INT(name, cctki3_cctkGH_,'),
        (bsnl '                             '.(crpt '[C]').','),
        (bsnl '                             imin,imax, cctki3_istr_,cctki3_imod_)'),
        (bsnl '  do {'),
        ...
        (bsnl '    CCTK_LOOP[DIM]STRMOD_INTERIOR(name##_int,'),
        (bsnl '                              cctki3_cctkGH,'),
        (bsnl '                              '.(crpt '[C]').','),
        ...
        (bsnl '                              imin,imax, (cctki3_istr_),(cctki3_imod_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD_INT(name)'),
        (bsnl '    } CCTK_ENDLOOP[DIM]STRMOD_INTERIOR(name##_int);'),
        ...
        (bsnl '                          '.(crpt 'n[C]').','),
        (bsnl '                          imin,imax, cctki3_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STRMOD_BND(name, (cctki3_cctkGH_),'),
        (bsnl '                       '.(crpt '[C]').','),
        (bsnl '                       '.(crpt 'n[C]').','),
        (bsnl '                       imin,imax, (cctki3_istr_), 0)'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_BND(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_BND(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD_BND(name, cctki3_cctkGH_,'),
        (bsnl '                             '.(crpt '[C]').','),
        (bsnl '                             '.(crpt 'n[C]').','),
        (bsnl '                             imin,imax, cctki3_istr_,cctki3_imod_)'),
        (bsnl '  do {'),
        ...
        (bsnl '    GetBoundarySizesAndTypes'),
        (bsnl '      (cctki3_cctkGH, [2*DIM], cctki3_bndsize, cctki3_is_ghostbnd, cctki3_is_symbnd, cctki3_is_physbnd);'),
        (bsnl '    CCTK_LOOP[DIM]STRMOD_BOUNDARIES(name##_bnd,'),
        (bsnl '                                cctki3_cctkGH,'),
        (bsnl '                                '.(crpt '[C]').','),
        (bsnl '                                '.(crpt 'n[C]').','),
        (bsnl '                                '.(crpt 'cctki3_bndsize[[2*I]]').','),
        ...
        (bsnl '                                imin,imax, (cctki3_istr_),(cctki3_imod_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD_BND(name)'),
        (bsnl '    } CCTK_ENDLOOP[DIM]STRMOD_BOUNDARIES(name##_bnd);'),
        ...
        (bsnl '                              '.(crpt 'n[C]').','),
        (bsnl '                              imin,imax, cctki3_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STRMOD_INTBND(name, (cctki3_cctkGH_),'),
        (bsnl '                           '.(crpt '[C]').','),
        (bsnl '                           '.(crpt 'n[C]').','),
        (bsnl '                           imin,imax, (cctki3_istr_), 0)'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_INTBND(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STRMOD_INTBND(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STRMOD_INTBND(name, cctki3_cctkGH_,'),
        (bsnl '                                 '.(crpt '[C]').','),
        (bsnl '                                 '.(crpt 'n[C]').','),
        (bsnl '                                 imin,imax, cctki3_istr_,cctki3_imod_)'),
        (bsnl '  do {'),
        ...
        (bsnl '    GetBoundarySizesAndTypes'),
        (bsnl '      (cctki3_cctkGH, [2*DIM], cctki3_bndsize, cctki3_is_ghostbnd, cctki3_is_symbnd, cctki3_is_physbnd);'),
        (bsnl '    CCTK_LOOP[DIM]STRMOD_INTBOUNDARIES(name##_intbnd,'),
        (bsnl '                                   cctki3_cctkGH,'),
        (bsnl '                                   '.(crpt '[C]').','),
        (bsnl '                                   '.(crpt 'n[C]').','),
        (bsnl '                                   '.(crpt 'cctki3_bndsize[[2*I]]').','),
        ...
        (bsnl '                                   imin,imax, (cctki3_istr_),(cctki3_imod_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STRMOD_INTBND(name)'),
        (bsnl '    } CCTK_ENDLOOP[DIM]STRMOD_INTBOUNDARIES(name##_intbnd);'),
