...
for $dim (1,2,3,4) {
    ...
    push @lines, map {expand $_} (
        ...
        (bsnl '                                '.(crpt 'cctki0_[C]max_').','),
        (bsnl '                                '.(crpt 'cctki0_[C]ash_').','),
        (bsnl '                                imin,imax, cctki0_istr_,cctki0_ioff_)'),
        (bsnl '  do {'),
        ...
        # Ensure stride modulus is compatible with stride
        (bsnl '    assert(cctki0_ioff>=0 && cctki0_ioff<cctki0_istr);'),
        ...
        (bsnl '                         '.(crpt 'cctki1_[C]max_').','),
        (bsnl '                         '.(crpt 'cctki1_[C]ash_').','),
        (bsnl '                         imin,imax, cctki1_istr_,cctki1_ioff_)'),
        (bsnl '  CCTK_LOOP[DIM]STROFF_NORMAL(name,'),
        (bsnl '                          '.(crpt '[C]').','),
        ...
        (bsnl '                                  '.(crpt 'cctki2_[C]blo_').','),
        (bsnl '                                  '.(crpt 'cctki2_[C]bhi_').','),
        (bsnl '                                  imin,imax, cctki2_istr_,cctki2_ioff_)'),
        (bsnl '  do {'),
        ...
        (rpt (bsnl '          (int)(cctki2_[C]dir<0 ? 0 : cctki2_[C]dir==0 ? cctki2_blo[[I]] : cctki2_lsh[[I]] - cctki2_bhi[[I]]),')),
        (bsnl '        };'),
        (bsnl '        const int cctki2_bmax[] = {'),
        (rpt (bsnl '          (int)(cctki2_[C]dir<0 ? cctki2_blo[[I]] : cctki2_[C]dir==0 ? cctki2_lsh[[I]] - cctki2_bhi[[I]] : cctki2_lsh[[I]]),')),
        (bsnl '        };'),
        ...
        (rpt (bsnl '                                cctki2_cctkGH->cctk_ash[[I]],')),
        (bsnl '                                imin,imax, cctki2_istr,cctki2_ioff) {'),
        (nl ''),
        ...
        (bsnl '  CCTK_LOOP[DIM]STROFF_ALL(name, (cctki3_cctkGH_),'),
        (bsnl '                       '.(crpt '[C]').','),
        (bsnl '                       imin,imax, (cctki3_istr_), 0)'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_ALL(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_ALL(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF_ALL(name, cctki3_cctkGH_,'),
        (bsnl '                             '.(crpt '[C]').','),
        (bsnl '                             imin,imax, cctki3_istr_,cctki3_ioff_)'),
        (bsnl '  do {'),
        ...
        (bsnl '                     imin,imax, (cctki3_istr_),(cctki3_ioff_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF_ALL(name)'),
        ...
        (bsnl '                          '.(crpt '[C]').','),
        (bsnl '                          imin,imax, cctki3_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STROFF_INT(name, (cctki3_cctkGH_),'),
        (bsnl '                       '.(crpt '[C]').','),
        (bsnl '                       imin,imax, (cctki3_istr_), 0)'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_INT(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_INT(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF_INT(name, cctki3_cctkGH_,'),
        (bsnl '                             '.(crpt '[C]').','),
        (bsnl '                             imin,imax, cctki3_istr_,cctki3_ioff_)'),
        (bsnl '  do {'),
        ...
        (bsnl '                              imin,imax, (cctki3_istr_),(cctki3_ioff_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF_INT(name)'),
        ...
        (bsnl '                          '.(crpt 'n[C]').','),
        (bsnl '                          imin,imax, cctki3_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STROFF_BND(name, (cctki3_cctkGH_),'),
        (bsnl '                       '.(crpt '[C]').','),
        (bsnl '                       '.(crpt 'n[C]').','),
        (bsnl '                       imin,imax, (cctki3_istr_), 0)'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_BND(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_BND(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF_BND(name, cctki3_cctkGH_,'),
        (bsnl '                             '.(crpt '[C]').','),
        (bsnl '                             '.(crpt 'n[C]').','),
        (bsnl '                             imin,imax, cctki3_istr_,cctki3_ioff_)'),
        (bsnl '  do {'),
        ...
        (bsnl '                                imin,imax, (cctki3_istr_),(cctki3_ioff_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF_BND(name)'),
        ...
        (bsnl '                              '.(crpt 'n[C]').','),
        (bsnl '                              imin,imax, cctki3_istr_)'),
        (bsnl '  CCTK_LOOP[DIM]STROFF_INTBND(name, (cctki3_cctkGH_),'),
        (bsnl '                           '.(crpt '[C]').','),
        (bsnl '                           '.(crpt 'n[C]').','),
        (bsnl '                           imin,imax, (cctki3_istr_), 0)'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STR_INTBND(name)'),
        (bsnl '  CCTK_ENDLOOP[DIM]STROFF_INTBND(name)'),
        (nl ''),
        (bsnl '#define CCTK_LOOP[DIM]STROFF_INTBND(name, cctki3_cctkGH_,'),
        (bsnl '                                 '.(crpt '[C]').','),
        (bsnl '                                 '.(crpt 'n[C]').','),
        (bsnl '                                 imin,imax, cctki3_istr_,cctki3_ioff_)'),
        (bsnl '  do {'),
        ...
        (bsnl '                                   imin,imax, (cctki3_istr_),(cctki3_ioff_)) {'),
        (nl ''),
        (bsnl '#define CCTK_ENDLOOP[DIM]STROFF_INTBND(name)'),
