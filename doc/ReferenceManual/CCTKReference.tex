...
{Register a routine as a \codeCCTK\_InterpGV} interpolation operator}
...
\showargs
\begin{params}
\parameter{number}{The number of grid variables compiled from the thorn's \cite{interface.ccl} files}
\end{params}
\begin{discussion}
\end{discussion}
\begin{examples}
