...
Current drivers (PUGH, Carpet, CarpetX) handle this case correctly
...
int count = 0;
int ierr = CCTK_ScheduleTraverse("MoL_PostStep", &count, CallFunction);
...
\begin{ResultSection}
\begin{Result}{ptr}
Pointer to the required data, should be cast to required type.
\end{Result}
\end{ResultSection}
\begin{ParameterSection}
\begin{Parameter}{ptr}
...
\end{Discussion}
\begin{ErrorSection}
\begin{Error}{\code{NULL}}
The variable does not exist or timelevel has no storage.
\end{Error}
\end{ErrorSection}
\begin{ExampleSection}
\begin{Example}{C}
