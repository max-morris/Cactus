...
Pointer to parameter value as string.  This string must be freed after
it has been used.
\end{Result}
\end{ResultSection}
...
As many characters as fit into the Fortran string.  You should check
for truncation by comparing \code{nchars} against the length of your
Fortran string.
\end{Parameter}
\end{ParameterSection}
...
omit the line number and name of the source file.
\end{Discussion}
