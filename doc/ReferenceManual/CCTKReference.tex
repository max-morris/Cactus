...
% Groups.c
\begin{FunctionDescription}{CCTK\_FullGroupName}{Given a group index, returns the group name}
\label{CCTK-FullGroupName}
\begin{SynopsisSection}
\begin{Synopsis}{C}
\begin{verbatim}const char * name = CCTK_FullGroupName(int index)\end{verbatim}
\end{Synopsis}
\end{SynopsisSection}
\begin{ParameterSection}
\begin{Parameter}{name}
