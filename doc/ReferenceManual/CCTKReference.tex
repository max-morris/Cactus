...
\item[\code{CCTK\_NumTimeLevels}] [\pageref{CCTK-NumTimeLevels}]
  Returns the number of timelevels from a group name
  \textbf{(deprecated)}

\item[\code{CCTK\_NumTimeLevelsGI}] [\pageref{CCTK-NumTimeLevels}]
  Returns the number of timelevels from a group index
  \textbf{(deprecated)}
...
\item[\code{CCTK\_NumTimeLevelsVI}] [\pageref{CCTK-NumTimeLevels}]
  Returns the number of timelevels from a variable index
  \textbf{(deprecated)}

\item[\code{CCTK\_NumTimeLevelsVN}] [\pageref{CCTK-NumTimeLevels}]
  Returns the number of timelevels from a variable name
  \textbf{(deprecated)}
...
Deprecated; same as \code{CCTK\_MaxTimeLevels}.
\end{SeeAlso2}
...
result of \code{CCTK\_MaxTimeLevels}, whichever is larger.
\end{Result}
\end{ResultSection}
...
at least as large as \code{CCTK\_MaxTimeLevels}.
\end{Discussion}
...
% cctk_GroupsOnGH.h
%Entering a function description for CCTK\_NumTimeLevels
\begin{FunctionDescription}{CCTK\_NumTimeLevels}
\label{CCTK-NumTimeLevels}
Returns the number of time levels for a group (deprecated).
