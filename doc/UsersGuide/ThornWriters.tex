...
\subsection{Specifically for C Programmers}
...
for (k=0; k<cctk_lsh[2]; k++)
{
  for (j=0; j<cctk_lsh[1]; j++)
  {
    ...
    {
      My3DGF [CCTK_GFINDEX3D(cctkGH,i,j,k)] = i*j*k;
    }
  }
}
\end{verbatim}
...
To output a variable using {\tt CCTK\_INFO} currently requires you
to use for Fortran something like
