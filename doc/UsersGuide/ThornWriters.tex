...
group tries to collect as many common feature as possible. That way
certain operation can be carried out an group by group basis, instead
time consuming function by functions}.
\item{Do function need to be communicated between different processors 
or are they local ?}
...
The {\tt interface.ccl} defines all the specific information. 
