...
\item a `README' containing a brief description of the thorn
\item a `doc' directory for documentation
\item a `par' directory for example parameter files
\item a `test' subdirectory may also be added.  See \ref{sec:testsuites} for details.
\end{itemize}
...
INT hitch ``The hitch-hiker parameter''
{
...
#better put a range!
INT hitch_nolimits ``The confusing hitch-hiker parameter''
{
