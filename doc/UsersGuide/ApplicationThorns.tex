...
\texttt{Driver\_RequireValidData}, \texttt{Driver\_NotifyDataModified}, \texttt{Driver\_GetValidRegion}, and \texttt{Driver\_GetValidRegion}. For details on these functions, please consult the appendix.
