...
The program should receive a single argument, a file name, and from it produce columns of ascii formatted floating
point numbers. The test system will run the postprocesser on both the files
...
\{
  POSTPROC \var{readhdf5} \var{h5\$}
\}
\end{alltt}

In the above example, files ending in ``h5'' are read using the readhdf5
