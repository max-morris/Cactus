...
\verb|{| is left as is.  Since \texttt{gmake} also interprets \verb|$$| in
order to have a \verb|$| show up to the shell it must be quadrupled
\verb|$$$$|. For example setting
\begin{verbatim}
CC = $${CXX} $(CXXFLAGS) -license ${HOME}/.license -I$$$${HDF5_HOME}/include
\end{verbatim}
expands \verb|${CXX}| and \verb|$(CXXFLAGS)| in the Makefile,
\verb|${HOME}| when \texttt{gmake <\var{config name}>-config} runs, and
\verb|${HDF5_HOME}| when the compiler \verb|${CXX}| runs.
