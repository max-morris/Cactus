...
\item[{\tt grid scalar}]
\item[{\tt grid variable}] A {\tt grid scalar}, {\tt grid function},
or {\tt grid array}.
...
\item[{\tt implementation}] See Section \ref{sec:im}.
\item[{\tt inherit}]
...
\begin{Lentry}
  ...
  \item[{\tt AT}] Functions can be scheduled to run at the Cactus schedule bins, for example {\tt CCTK\_EVOL}, {\tt CCTK\_STARTUP}. A complete list and description
	of these is provided in Appendix~\ref{sec:scbi}.
