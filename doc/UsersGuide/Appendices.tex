...
{\tt cvs -d :pserver:}{\em your\_login}{\tt
@cvs.cactuscode.org:<repository\_name> } import {\em relative name} {\tt start V1}\\
Where {\em <relative name>} means the position of the directory within the module. (For example, if you have a module called {\em AMod} which contains a 
