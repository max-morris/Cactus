...
This is similar to \texttt{-W}, but for standard error instead of
...
This is similar to \texttt{-W}, but for fatal errors: Cactus treats all
...
Set the level of parameter checking to be used, one of \texttt{strict},
