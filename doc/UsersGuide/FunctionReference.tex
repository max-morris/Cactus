...
\item[CCTK\_NumTimeLevelsI]
  [\pageref{CCTK-NumTimeLevelsI}]
  Gives the number of timelevels for a group
...
\begin{examples}
\begin{tabular}{@{}p{3cm}cp{11cm}}
\hfill {\bf C} && {\t numlevels = CCTK\_NumTimeLevels("evolve::phivars") ;}
\\
\hfill {\bf Fortran} && {\t call CCTK\_NUMTIMELEVELS(numlevels,"evolve::phivars")}\\
\\
\end{tabular}
\end{examples}
\begin{errorcodes}
...
% Groups.c
\begin{CCTKFunc}{CCTK\_NumTimeLevelsI}{Gives the number of timelevels for a group}
\label{CCTK-NumTimeLevelsI}
\subroutine{int}{integer}{numlevels}
\argument{int}{integer}{index}
\showargs
\begin{params}
...
\hfill {\bf C} && {\t index = CCTK\_GroupIndex("evolve::phivars")}\\
               &&{\t numlevels = CCTK\_NumTimeLevelsI(index) ;}
\\
\hfill {\bf Fortran} && {\t call CCTK\_NUMTIMELEVELSI(numlevels,3)}\\
\\
\end{tabular}
\end{examples}
\begin{errorcodes}
