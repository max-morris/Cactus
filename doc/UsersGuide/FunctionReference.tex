...
\end{Error}
\begin{Error}{CCTK\_ERROR\_INTERP\_GRID\_TOO\_TINY}
...
\begin{Synopsis}{Fortran}
\begin{verbatim}
call Util_TableGetGenericArray(N_elements, handle, type_code, N_array, array, key)
...
\begin{Synopsis}{Fortran}
\begin{verbatim}
call Util_TableQueryValueInfo(key_exists, handle, type_code, N_elements, key)
...
\begin{Synopsis}{Fortran}
\begin{verbatim}
call Util_TableSetGenericArray(status, handle, type_code, N_elements, array, key)
