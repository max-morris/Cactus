...
(This function is currently being implemented; it should be available
...
/* simple example */
int table_handle = Util_TableCreateFromString("order=3");
CCTK_SomeCactusFunction(..., table_handle, ...);
Util_TableDestroy(table_handle);

/* larger example */
int table_handle = Util_TableCreate(UTIL_TABLE_FLAGS_CASE_INSENSITIVE);
Util_TableSetInt(table_handle, 3, "n");
Util_TableSetReal(table_handle, 3.0e-5, "dx");

/* this is equivalent to the previous 3 lines of code */
int table_handle = Util_TableCreateFromString("n=3 dx=3.0e-5");
\end{verbatim}
\end{Example}
\end{FunctionDescription}
