...
\item[CCTK\_GroupbboxGI] [\pageref{CCTK-GroupbboxGI}]
  Given a group index, return an array of the bounding box of the group

\item[CCTK\_GroupbboxGN] [\pageref{CCTK-GroupbboxGN}]
  Given a group name, return an array of the bounding box of the group

\item[CCTK\_GroupbboxVI] [\pageref{CCTK-GroupbboxVI}]
  Given a variable index, return an array of the bounding box of the variable

\item[CCTK\_GroupbboxVN] [\pageref{CCTK-GroupbboxVN}]
  Given a variable name, return an array of the bounding box of the variable
...
\item[CCTK\_GrouplbndGI] [\pageref{CCTK-GrouplbndGI}]
  Given a group index, return an array of the lower bounds of the group in rach dimension

\item[CCTK\_GrouplbndGN] [\pageref{CCTK-GrouplbndGN}]
  Given a group name, return an array of the lower bounds of the group in rach dimension

\item[CCTK\_GrouplbndVI] [\pageref{CCTK-GrouplbndVI}]
  Given a variable index, return an array of the lower bounds of the variable in rach dimension

\item[CCTK\_GrouplbndVN] [\pageref{CCTK-GrouplbndVN}]
  Given a variable name, return an array of the lower bounds of the variable in rach dimension
...
\item[CCTK\_GroupubndGI] [\pageref{CCTK-GroupubndGI}]
  Given a group index, return an array of the upper bounds of the group in rach dimension

\item[CCTK\_GroupubndGN] [\pageref{CCTK-GroupubndGN}]
  Given a group name, return an array of the upper bounds of the group in rach dimension

\item[CCTK\_GroupubndVI] [\pageref{CCTK-GroupubndVI}]
  Given a variable index, return an array of the upper bounds of the variable in rach dimension

\item[CCTK\_GroupubndVN] [\pageref{CCTK-GroupubndVN}]
  Given a variable name, return an array of the upper bounds of the variable in rach dimension
...
Given a group index or name, return an array of the bounding box of the group
...
Given a variable index or name, return an array of the bounding box of the variable
...
integer      input_array_variable_indices(N_input_arrays)
integer      output_array_type_codes(N_output_arrays)
...
thorns (eg. {\tt PUGHInterp} in the {\tt CactusPUGH} arrangement and
{\tt LocalInterp} in the {\tt CactusBase} arrangement) for details.
...
corresponding interpolation thorn(s) you are using.
\end{Error}
...
options, e.g.\hbox{} the interpolation order)
\end{Error}
...
\begin{ResultSection}
\begin{Result}{size\_t}
The size of the string the function tried to create -- i.e. the
initial size of dst plus the size of src.
\end{Result}
\end{ResultSection}
...
The strlcat function is a safer alternative to strncat, and is
available in OpenBSD.  Since it is not POSIX, we provide an equivalent
utility function.

This function appends the NULL-terminated string src to the end of
dst.  It appends at most size - strlen(dst) - 1 bytes and
NULL-terminates the result.  Note that both src and dst must be proper
...
\begin{ResultSection}
\begin{Result}{size\_t}
The size of the string the function tried to create -- i.e. the size
of src.
\end{Result}
\end{ResultSection}
...
The strlcpy function is a safer alternative to strncpy, and is
available in OpenBSD.  Since it is not POSIX, we provide an equivalent
utility function.

This function copies up to size-1 bytes from the source string to the
destination string, and null-terminates the result (unlike strncpy
which does not guarantee null-termkination).  Note that src must be a
proper C null-terminated string.
