...
\item[CCTK\_Equals]
  [\pageref{CCTK-Equals}]
  Check a STRING or KEYWORD parameter for equality with a given string
...
%main/Groups.c
% Please document CCTK_GroupTagsTableI and CCTK_GroupTagsTable.
...
below this are reserved for present or future Cactus use.
