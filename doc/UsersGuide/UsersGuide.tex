...
{\Large \bf Overview of documentation}
...
Please contact {\it cactusmaint@cactuscode.org} if you need to know something
which isn't yet documented, and we will try our best to add it as soon
as possible. 
...
\item {\bf Part B: Application Thorn Writing.} We introduce a
...
Other topics to be discussed in separate documents:

\begin{itemize}

\item Computational Thorn Guide

\item Relativity Thorn Guide

\item Maintainer Guide to the Flesh

\end{itemize}

For now, we give here a short guide to terms used in this document:

\begin{itemize}

\item[CCTK] Cactus Computational Tool Kit (The Cactus flesh and
            computational thorns).
\item[CCL] Cactus Configuration Language
\item[flesh] The routines which hold all the thorns together.
\item[thorn] A collection of subroutines with a definite interface 
             and purpose
\item[arrangement] A collection of thorns
